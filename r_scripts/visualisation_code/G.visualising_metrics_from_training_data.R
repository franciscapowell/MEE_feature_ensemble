...
plot <- plot_recall_changes(all_metrics) + My_Theme 
...
jpeg(file = "figures/300_dpi/training_F1_boxplot.jpeg", units="mm", width=568, height=315, res=300)
plot_F1_changes(all_metrics) + My_Theme
dev.off()
